...
export default function ManifestPage() {
  ...
  const filtered = useMemo(() => {
    return manifestData.filter((row) => {
      ...
      const matchArrival =
        ...
        (dateArrivalFrom &&
          !dateArrivalTo &&
          row.dateArrival >= startOfDay(dateArrivalFrom)) ||
  ...
  const exportPDF = async () => {
    ...
    const body = filtered.map((r) => [
      ...
      r.airline,
      r.voyageNo ?? "-",
      format(r.dateReg, "yyyy-MM-dd"),
      format(r.dateArrival, "yyyy-MM-dd"),
    ]);
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-300">
          Track and filter recent cargo manifests
        </p>
      </div>
      ...
      <div className="bg-gradient-to-br from-[#1e293b] to-[#0f172a] p-6 rounded-xl shadow-md border border-[#063064]">
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          <Button onClick={setToday} className="bg-[#063064] text-white">
            Today
          </Button>
          <Button onClick={setThisWeek} className="bg-[#063064] text-white">
            This Week
          </Button>
          <Button onClick={setThisMonth} className="bg-[#063064] text-white">
            This Month
          </Button>
          <Button
            variant="outline"
      ...
      <div className="bg-[#0D0E10] p-6 rounded-xl border border-[#063064] text-white">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={exportExcel} className="bg-yellow-500 hover:bg-yellow-600 text-black">
      ...
      {/* Submit Section */}
      <div className="bg-gradient-to-br from-[#0D0E10] to-[#1a1f2e] p-6 rounded-xl border border-[#063064] text-white">
        <h2 className="text-lg font-semibold mb-2">
          Submit Your Waybill / Bill of Lading
        </h2>
        <div className="flex gap-4">
          ...
          />
          <Link href="/contact">
            <Button className="bg-[#F7D234] text-black hover:bg-[#e0c020]">
              Submit
            </Button>
          </Link>
        </div>
